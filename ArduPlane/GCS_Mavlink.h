...
// Manual control input range in uSec as specified by https://mavlink.io/en/messages/common.html#MANUAL_CONTROL
#define RC_OVERRIDE_MAX 1000
...
private:
    ...
    bool handle_guided_request(AP_Mission::Mission_Command &cmd, Vector2f velNE, float radius) override;
