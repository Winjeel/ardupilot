...
public:
    ...
    // A positive value indicates a CW loiter, a negative value indicates a CCW loiter
...
private:
    ...
    // radius of loiter in metres after adjustment for vehicle limits and as used by the controller
    // a positive value indicates a CW loiter, a negative value indicates a CCW loiter
