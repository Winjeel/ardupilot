...
void AP_MotorsTailsitter::output_to_motors()
{
    ...
    switch (_spool_mode) {
        ...
        case SPOOL_DOWN: {
            ...
            throttle_left  = constrain_float(throttle + _rudder*0.5, _spin_min, 1) * _esc_thr_gain;
            throttle_right = constrain_float(throttle - _rudder*0.5, _spin_min, 1) * _esc_thr_gain;
