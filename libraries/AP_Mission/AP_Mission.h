...
public:
    ...
    // set to true if current mission has been received over mavlink
    // set to false if current mission was generated by the flight vehicle
    void set_is_mavlink_mission(bool is_mavlink) {_is_mavlink_mission = is_mavlink;}

    // return true if a mission was received over mavlink
    bool get_is_mavlink_mission() {return _is_mavlink_mission;}
...
private:
    ...
    // true if the current mission was received via mavlink
    bool _is_mavlink_mission;
