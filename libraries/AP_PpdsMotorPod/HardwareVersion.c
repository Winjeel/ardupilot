// HardwareVersion.c was generated by ProtoGen version 2.17.b
...
/*!
 * \brief Encode a HardwareVersion_t structure into a byte array
 *
 ...
 */
void encodeHardwareVersion_t(uint8_t* _pg_data, int* _pg_bytecount, const HardwareVersion_t* _pg_user)
{
...
}// encodeHardwareVersion_t

/*!
 * \brief Decode a HardwareVersion_t structure from a byte array
 *
 * Hardware revision information.
 ...
 */
int decodeHardwareVersion_t(const uint8_t* _pg_data, int* _pg_bytecount, HardwareVersion_t* _pg_user)
{
    int _pg_byteindex = *_pg_bytecount;
...
}// decodeHardwareVersion_t

/*!
 * \brief Create the HardwareVersion packet
 *
 * Hardware revision information.
 * \param _pg_pkt points to the packet which will be created by this function
 * \param _pg_user points to the user data that will be encoded in _pg_pkt
 */
void encodeHardwareVersionPacketStructure(CorvoPacket* _pg_pkt, const HardwareVersion_t* _pg_user)
{
    ...
    finishPpdsMotorPodPacket(_pg_pkt, _pg_byteindex, getHardwareVersionPacketID());
}

/*!
 * \brief Decode the HardwareVersion packet
 *
 * Hardware revision information.
 ...
 */
int decodeHardwareVersionPacketStructure(const CorvoPacket* _pg_pkt, HardwareVersion_t* _pg_user)
{
    int _pg_numbytes;
    int _pg_byteindex = 0;
    ...
    if(getPpdsMotorPodPacketID(_pg_pkt) != getHardwareVersionPacketID())
        return 0;

    // Verify the packet size
    _pg_numbytes = getPpdsMotorPodPacketSize(_pg_pkt);
    if(_pg_numbytes < getHardwareVersionMinDataLength())
        return 0;
