...
size_t SL_MsgBuffer::copyMsg(void * const out, const size_t num) {
    return extract(out, num, 0);
}

size_t SL_MsgBuffer::copyData(void * const out, const size_t num) {
    return extract(out, num, kHeaderSz);
}
